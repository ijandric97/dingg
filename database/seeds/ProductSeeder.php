...
class ProductSeeder extends Seeder
{
    ...
    {
        $products = [
            ['name' => 'Hamby double burger', 'description' => 'Pecivo, 2x pljeskavica, zelena salata, umak aurora, kiseli krastavci, rajčica', 'image_path' => 'placeholder.png', 'price' => 35, 'discount' => 0.10, 'available' => true, 'group_id' => 1],
