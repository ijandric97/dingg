...
<div class="btn-group" role="group" style="vertical-align: super;">
    ...
    <button type="button" class="btn btn-danger on-top" data-toggle="modal" data-target="#CategoryDeleteModal" data-id="{{$category->id}}" data-title="{{$category->name}}">🗑️ Delete</button>
</div>
@endcan
