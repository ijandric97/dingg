...
<div class="container">
    ...
    <div class="card border-primary mb-3">
        <div class="card-header d-flex">
            ...
            {{-- Orders Button --}}
            <a class="btn btn-primary ml-auto" href="{{route('restaurant.edit', $restaurant)}}" role="button">🧾 Orders</a>
            ...
            <div class="dropdown ml-2">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="{{route('restaurant.product.index', $restaurant)}}">Products</a>
                </div>
            </div>
            ...
            <form method="POST" action="{{route('restaurant.destroy', $restaurant->id)}}">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn ml-2 btn-danger" onclick="deleteConfirm(event)">🗑️ Delete</button>
            </form>
            @endcan
        </div>
    </div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-md-4 mb-3">
            ...
            <a href="@auth {{route('restaurant.order', $restaurant->id)}} @else {{route('register')}} @endauth"
        ...
        <div class="col-md-8 text-center text-md-left">
            ...
            <div class="d-inline-block">
                ...
                <a href="{{route('category.show', $category->id)}}" class="btn btn-dark btn-secondary active mb-2"
                    style="vertical-align: super;" role="button">{{$category->name}}</a>
                @endforeach
            </div>
            ...
            <div class="d-inline-block mb-3">
                <button
                    ...
                    style="opacity: 1; vertical-align: super;">⭐ {{$rating}} / 5</button>
            ...
            <table class="table table-sm">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{$restaurant->website}}">{{$restaurant->website}}</>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="row mb-2">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="d-flex justify-content-between btn-group" role="group">
                <button type="button" class="btn btn-primary" onclick="cycleGroup(false)"
                    style="border-radius: 0.25rem 0px 0px 0px;">←</button>
                <button type="button" class="btn btn-primary disabled" style="opacity: 1;">
                    <h3 class="d-inline">Menu</h3>
                </button>
                <button type="button" class="btn btn-primary" onclick="cycleGroup(true)"
                    style="border-radius: 0px 0.25rem 0px 0px;">→</button>
            </div>
        ...
        <div class="col-md-8">
            ...
            <h3 class="d-inline-block mr-2 mb-2">Comments
                @auth
                <button id="addCommentBtn" class="ml-2 btn btn-success" onClick="toggleCommentForm()" role="button">✎
                    Add</button>
                @endauth
            </h3>
                    ...
                    <div class="card-header">
                        <div class="form-group"> {{-- Title --}}
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                placeholder="Title of your comment" name="title" value="{{old('title')}}" required>
                            @error('name')
                        ...
                        <div class="form-group"> {{-- Rating --}}
                            ...
                            <input type="range" class="form-control-range bg-warning" name="rating" id="addCommentRange"
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <img src="{{asset('storage/images/restaurant/' . $restaurant->image_path)}}" alt="..." width=64
                    ...
                    <div class="d-inline-block" style="vertical-align: middle;">
                        ...
                        <h6 class="card-subtitle mb-2 text-muted">by {{$comment->user()->get()[0]->name}} at
...
<script>
    function imgError() {
        this.onerror=null;
        this.src="{{asset('storage/images/restaurant/placeholder.png')}}";
    }

    @can('edit-restaurant', $restaurant)
        function deleteConfirm(event) {
            if (!confirm("Are you sure you want to delete restaurant?")) {
